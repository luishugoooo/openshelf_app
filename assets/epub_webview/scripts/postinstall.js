...
if (!fs.existsSync(packageJsonPath)) {
  console.log("ℹ️  @intity/epub-js not found, skipping postinstall fix");
  process.exit(0);
}
...
try {
  ...
  if (needsFix) {
    ...
    // Build the package
    console.log("🔨 Building @intity/epub-js...");
    execSync("npm run prepare", { cwd: epubJsPath, stdio: "inherit" });
